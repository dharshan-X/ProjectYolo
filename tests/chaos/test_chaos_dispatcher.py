...
if __name__ == "__main__":
    # Manual test run
    async def run_tests():
        await test_dispatcher_success()
        print("test_dispatcher_success passed")
        await test_dispatcher_json_args()
        print("test_dispatcher_json_args passed")
        await test_dispatcher_invalid_json()
        print("test_dispatcher_invalid_json passed")
        await test_dispatcher_not_found()
        print("test_dispatcher_not_found passed")
        await test_dispatcher_exception()
        print("test_dispatcher_exception passed")
        await test_dispatcher_non_str_return()
        print("test_dispatcher_non_str_return passed")
        await test_dispatcher_retry()
        print("test_dispatcher_retry passed")
        await test_dispatcher_injection()
        print("test_dispatcher_injection passed")
