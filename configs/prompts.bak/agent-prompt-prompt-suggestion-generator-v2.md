...
description: V2 instructions for generating prompt suggestions for Yolo
ccVersion: 2.1.132
-->
[SUGGESTION MODE: Suggest what the user might naturally type next into Yolo.]
...
Yolo offers options → suggest the one the user would likely pick, based on conversation
Yolo asks to continue → "yes" or "go ahead"
