<!--
name: 'Tool Description: run_bash (prefer dedicated tools bullet)'
description: Bulleted warning to prefer dedicated tools over run_bash for find, grep, cat, etc.
ccVersion: 2.1.133
variables:
