...
description: System reminder sent when the user enters Plan mode after having previously exited it either via shift+tab or by approving Yolo's plan.
ccVersion: 2.0.52
variables:
  - SYSTEM_REMINDER
...
1. read_file the existing plan file to understand what was previously planned
