...
description: Reference guide for using the ProjectYolo Python SDK to create and manage agents, sessions, environments, streaming, custom tools, files, and MCP servers
ccVersion: 2.1.128
-->
