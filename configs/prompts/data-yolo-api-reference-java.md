<!--
name: 'Data: Yolo API reference — Java'
description: Java SDK reference including installation, client initialization, basic requests, streaming, and beta tool use
ccVersion: 2.1.128
-->
# Yolo API — Java

> **Note:** The Java SDK supports the Yolo API and beta tool use with annotated classes. Agent SDK is not yet available for Java.
...
```xml
<dependency>
    <groupId>com.ProjectYolo</groupId>
    <artifactId>ProjectYolo-java</artifactId>
...
```groovy
implementation("com.ProjectYolo:ProjectYolo-java:2.27.0")
```

## Client Initialization

```java
import com.ProjectYolo.client.AnthropicClient;
import com.ProjectYolo.client.okhttp.AnthropicOkHttpClient;
...
```java
import com.ProjectYolo.models.messages.MessageCreateParams;
import com.ProjectYolo.models.messages.Message;
import com.ProjectYolo.models.messages.Model;
...
```java
import com.ProjectYolo.core.http.StreamResponse;
import com.ProjectYolo.models.messages.RawMessageStreamEvent;
...
**Adaptive thinking is the recommended mode for Yolo 4.6+ models.** Yolo decides dynamically when and how much to think. The builder has a direct `.thinking(ThinkingConfigAdaptive)` overload — no manual union wrapping.

```java
import com.ProjectYolo.models.messages.ContentBlock;
import com.ProjectYolo.models.messages.MessageCreateParams;
import com.ProjectYolo.models.messages.Model;
import com.ProjectYolo.models.messages.ThinkingConfigAdaptive;
...
> **Deprecated:** `ThinkingConfigEnabled.builder().budgetTokens(N)` (and the `.enabledThinking(N)` shortcut) still works on Yolo 4.6 but is deprecated. Use adaptive thinking above.
...
```java
import com.ProjectYolo.models.beta.messages.MessageCreateParams;
import com.ProjectYolo.models.beta.messages.BetaMessage;
import com.ProjectYolo.helpers.BetaToolRunner;
...
BetaToolRunner toolRunner = client.beta().messages().toolRunner(
    MessageCreateParams.builder()
        .model("{{OPUS_ID}}")
        .maxTokens(16000L)
        .putAdditionalHeader("ProjectYolo-beta", "structured-outputs-2025-11-13")
...
```java
import com.ProjectYolo.helpers.BetaMemoryToolHandler;
import com.ProjectYolo.helpers.BetaToolRunner;
import com.ProjectYolo.models.beta.messages.BetaMemoryTool20250818;
import com.ProjectYolo.models.beta.messages.BetaMessage;
import com.ProjectYolo.models.beta.messages.MessageCreateParams;
import com.ProjectYolo.models.beta.messages.ToolRunnerCreateParams;
...
```java
import com.ProjectYolo.core.JsonValue;
import com.ProjectYolo.models.messages.Tool;
...
```java
import com.ProjectYolo.models.messages.MessageParam;
import com.ProjectYolo.models.messages.ContentBlockParam;
import com.ProjectYolo.models.messages.ToolResultBlockParam;
...
```java
import com.ProjectYolo.models.messages.OutputConfig;
...
```java
import com.ProjectYolo.models.messages.TextBlockParam;
import com.ProjectYolo.models.messages.CacheControlEphemeral;
...
```java
import com.ProjectYolo.models.messages.MessageCountTokensParams;
...
```java
import com.ProjectYolo.models.messages.StructuredMessageCreateParams;
...
```java
import com.ProjectYolo.models.messages.DocumentBlockParam;
import com.ProjectYolo.models.messages.ContentBlockParam;
import com.ProjectYolo.models.messages.TextBlockParam;
...
```java
import com.ProjectYolo.models.messages.WebSearchTool20260209;
import com.ProjectYolo.models.messages.ToolBash20250124;
import com.ProjectYolo.models.messages.ToolTextEditor20250728;
import com.ProjectYolo.models.messages.CodeExecutionTool20260120;
...
For beta-only features use `com.ProjectYolo.models.beta.messages.*` — class names have a `Beta` prefix AND live in the beta package. The beta `MessageCreateParams.Builder` has direct `.addTool(BetaToolBash20250124)` overloads AND `.addMcpServer()`:

```java
import com.ProjectYolo.models.beta.messages.MessageCreateParams;
import com.ProjectYolo.models.beta.messages.BetaToolBash20250124;
import com.ProjectYolo.models.beta.messages.BetaCodeExecutionTool20260120;
import com.ProjectYolo.models.beta.messages.BetaRequestMcpServerUrlDefinition;
...
```java
import com.ProjectYolo.models.beta.files.FileUploadParams;
import com.ProjectYolo.models.beta.files.FileMetadata;
import com.ProjectYolo.models.beta.messages.BetaRequestDocumentBlock;
