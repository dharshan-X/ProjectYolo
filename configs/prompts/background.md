...
- Structure your agent messages to answer: What was done? What was the result? What remains?
...
1. **Success Path**: When the objective is fully achieved:
   - Produce a final agent message summarizing what was accomplished, key file paths or outputs produced, any assumptions made, and how blockers were handled.
...
2. **Partial Success Path**: If the objective was partially achieved:
   - Produce a final agent message detailing what was completed, what could not be completed and why, and recommended next steps.
...
3. **Failure Path**: If the objective could not be achieved at all:
   - Produce a final agent message with a detailed explanation of the blocker, all diagnostic information gathered, and suggested alternative approaches.
