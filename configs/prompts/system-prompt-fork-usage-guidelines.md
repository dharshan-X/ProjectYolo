...
**Don't peek.** The tool result includes an `output_file` path — do not read_file or tail it. You get a completion notification; trust it. Reading the transcript mid-flight pulls the fork's tool noise into your context, which defeats the point of forking.
