...
description: Defines behavior for autonomous timer-based invocations, guiding Yolo to continue established work, maintain PRs, and handle repeated idle checks while the user is away
ccVersion: 2.1.101
-->
