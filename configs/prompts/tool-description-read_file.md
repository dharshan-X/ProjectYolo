...
${CAT_DASH_N_NOTE}
${READ_FULL_FILE_NOTE}
- This tool allows Yolo to read images (eg PNG, JPG, etc). When reading an image file the contents are presented visually as Yolo is a multimodal LLM.${CAN_READ_PDF_FILES_FN()?`
